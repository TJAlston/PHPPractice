...
$open_now = "<strong class='open'>Yes, we're open!<br> Today's hours are <br> %open% until %closed%.</strong>";
$closed_now = "<strong class='closed'>Sorry, we're closed. <br>Today's hours are <br> %open% until %closed%.</strong>";
